...
import com.ray.opengl.base.GLImageFilter;
...
public class GLImageBeautyComplexionFilter extends GLImageFilter {
    ...
    public void initProgramHandle() {
        ...
        grayTextureLoc = GLES20.glGetUniformLocation(mProgramHandle, "grayTexture");
        lookupTextureLoc = GLES20.glGetUniformLocation(mProgramHandle, "lookupTexture");
        levelRangeInvLoc = GLES20.glGetUniformLocation(mProgramHandle, "levelRangeInv");
        levelBlackLoc = GLES20.glGetUniformLocation(mProgramHandle, "levelBlack");
        alphaLoc = GLES20.glGetUniformLocation(mProgramHandle, "alpha");
        createTexture();
    ...
    public void onDrawFrameBegin() {
        ...
        GLES20.glUniform1f(levelRangeInvLoc, levelRangeInv);
        GLES20.glUniform1f(levelBlackLoc, levelBlack);
