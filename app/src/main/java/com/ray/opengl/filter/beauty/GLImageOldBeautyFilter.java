...
import com.ray.opengl.filter.beauty.bean.IBeautify;
...
public class GLImageOldBeautyFilter extends GLImageFilter implements IBeautify {
    ...
    public void initProgramHandle() {
        ...
        mWidthLoc = GLES20.glGetUniformLocation(mProgramHandle, "width");
        mHeightLoc = GLES20.glGetUniformLocation(mProgramHandle, "height");
        mOpacityLoc = GLES20.glGetUniformLocation(mProgramHandle, "opacity");
