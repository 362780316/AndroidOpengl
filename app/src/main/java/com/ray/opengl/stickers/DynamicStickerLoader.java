package com.ray.opengl.stickers;
...
import com.ray.opengl.resource.ResourceIndexCodec;
import com.ray.opengl.stickers.bean.DynamicStickerData;
import com.ray.opengl.utils.BitmapUtils;
...
public class DynamicStickerLoader {
    ...
    // 贴纸滤镜
    private final WeakReference<CatFilter> mWeakFilter;
    public DynamicStickerLoader(boolean isStaticSticker, CatFilter filter, DynamicStickerData stickerData, String folderPath) {
...
//                mWeakFilter.get().setLooping(mStickerData.audioLooping);
    ...
    public DynamicStickerLoader(CatFilter filter, DynamicStickerData stickerData, String folderPath) {
